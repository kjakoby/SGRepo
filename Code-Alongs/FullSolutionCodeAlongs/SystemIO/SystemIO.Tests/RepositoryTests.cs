...
namespace SystemIO.Tests
{
    ...
    {
        private const string _filePath = @"D:\SoftwareGuild\new-kyle-jakoby-individual-work\Data\SystemIO\StudentTest.txt";
        private const string _originalData = @"D:\SoftwareGuild\new-kyle-jakoby-individual-work\Data\SystemIO\StudentTestSeed.txt";
